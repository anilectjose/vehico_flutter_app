            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: FitnessAppTheme.nearlyRed.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      FitnessAppTheme.nearlyRed.withOpacity(0.2),
                      FitnessAppTheme.nearlyRed.withOpacity(0.5)
                    ],
            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: [
                      FitnessAppTheme.nearlyRed.withOpacity(0.4),
